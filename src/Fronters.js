  ...
  return (
    <div className="p-4">
        <div>
            ...
            <p>this isn&apos;t an exhaustive list, and people aren&apos;t shown in any particular order!</p>
        </div>
        <Separator />
        ...
        <Separator />
        <div>
            <LinkButton to="/about">about</LinkButton> <LinkButton to="/links">links</LinkButton>
        </div>
    </div>
  )
}
...
function Member (props) {
  return (
    <div className="flex flex-col max-w-md justify-center text-center">
        {props.member.avatar ? <img className="w-2/3 mx-auto rounded-full" src={props.member.avatar} /> : ''}
